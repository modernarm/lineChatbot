...
class LineBot extends EventEmitter {
	...
	constructor(options) {
		...
		this.options.channelId = options.channelId || '1550078548';
		this.options.channelSecret = options.channelSecret || 'd11f68442352c588e6d59d0f79f147a0';
		this.options.channelAccessToken = options.channelAccessToken || '3NUfbALwyOEEBy/P8zE2QxoIn5fEA+7JuhUuWQa+ilRpMxjXvJY6PEAuNLIeXGYygIY+9gRmfxhCnOB/Bw/4czyLimBd+Md00rEUzseEuuYuKcAlPgMhhW46L8aEKPWG6sQrR6J1rGzn/AkN2YFYkgdB04t89/1O/w1cDnyilFU=';
